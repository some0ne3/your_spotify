...
import { up as add_visible_top_songs_columns } from "./migrations/1708973485303-add_visible_top_songs_columns";
  ...
  load(
    {
      migrations: {
        ...
        "1708973485303-add_visible_top_songs_columns.js": {
          up: add_visible_top_songs_columns,
          down: noop,
        },
      },
